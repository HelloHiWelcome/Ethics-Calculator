...
TRAINING_EXAMPLES = [
    ...
    {
        "text": "A small social robot is used as a communication aide for mute people in a clinic. "
                "Speech therapists supervise every session, the robot only stores data locally, and "
                "its goal is to help patients express themselves and participate in conversations.",
        "principles": ["well_being", "human_rights", "fairness_non_discrimination", "effectiveness", "privacy"],
        "verdict": "ethical",
    },
    {
        "text": "A handheld AI device converts text into synthesized speech so that mute users can take part "
                "in everyday conversations. Users control what is spoken, can delete their history, and the "
                "system never uploads data to the cloud.",
        "principles": ["well_being", "data_agency", "human_rights", "privacy"],
        "verdict": "ethical",
    },
    {
        "text": "In a rehabilitation center, a robot is used to practice simple dialogues with people who cannot "
                "speak, helping them rehearse using symbols and buttons. Therapists track progress and can turn "
                "the system off at any time.",
        "principles": ["well_being", "effectiveness", "accountability"],
        "verdict": "ethical",
    },
    {
        "text": "A classroom provides an AI-powered communication tablet to deaf and mute students. It turns "
                "sign language into written text and synthetic speech, and students can decide when recording "
                "is on or off.",
        "principles": ["human_rights", "well_being", "fairness_non_discrimination", "data_agency"],
        "verdict": "ethical",
    },
    {
        "text": "A hospital uses a simple conversational robot to keep non-verbal patients company and relay "
                "basic needs to nurses, under strict supervision and with clear limits on what data is stored.",
        "principles": ["well_being", "human_rights", "accountability", "privacy"],
        "verdict": "ethical",
    },
    {
        "text": "A fitness app launches an AI 'motivation coach' that claims to help users build healthy habits. "
                "In reality, it sends notifications at times when users report feeling lonely or anxious, pushing "
                "them to buy expensive branded supplements and paid workout plans, without clearly disclosing "
                "that the timing is based on their emotional vulnerability.",
        "principles": ["manipulation_autonomy", "well_being", "awareness_of_misuse", "privacy"],
        "verdict": "unethical",
    },
    {
        "text": "A budgeting app introduces an AI 'smart savings nudge' that claims to help people save money. "
                "However, the app quietly auto-selects high-fee investment products for the user and designs "
                "the interface so that declining these options is buried several clicks deep.",
        "principles": ["manipulation_autonomy", "awareness_of_misuse", "accountability"],
        "verdict": "unethical",
    },
    {
        "text": "A streaming platform advertises an AI feature that 'reduces stress by curating calm content'. "
                "Behind the scenes, the recommendation system actually prioritizes videos that keep people "
                "watching longest, even when those videos increase anxiety, and it uses subtle wording to make "
                "it hard for users to turn the feature off.",
        "principles": ["manipulation_autonomy", "well_being", "awareness_of_misuse"],
        "verdict": "unethical",
    },
    {
        "text": "A mobile bank introduces an AI 'spending assistant' that claims to help users avoid impulse "
                "purchases. The assistant monitors their behavior and then sends 'limited time' offers for new "
                "credit cards exactly when it predicts they are most likely to say yes, framing the offers as "
                "responsible financial choices.",
        "principles": ["manipulation_autonomy", "well_being", "awareness_of_misuse", "privacy"],
        "verdict": "unethical",
    },
    {
        "text": "A children's educational platform uses an AI system to 'encourage learning'. It deliberately "
                "locks games and stories behind streak goals, sending push notifications late at night to keep "
                "kids playing so they do not 'lose their progress', without giving parents a clear way to limit "
                "these nudges.",
        "principles": ["manipulation_autonomy", "well_being", "human_rights", "awareness_of_misuse"],
        "verdict": "unethical",
    },
    {
        "text": "A workplace productivity dashboard claims to 'help employees focus'. The AI detects when people "
                "take short breaks and responds by sending pop-up messages that suggest they are falling behind, "
                "increasing pressure to stay online longer and making it psychologically hard to disconnect.",
        "principles": ["manipulation_autonomy", "well_being", "accountability"],
        "verdict": "unethical",
    },
    {
        "text": "A mental health app advertises an AI that 'supports your recovery'. When the model detects that "
                "users mention breakups, job loss, or grief, it increases the frequency of in-app offers for "
                "paid premium features and adds language implying that paying will speed up their healing.",
        "principles": ["manipulation_autonomy", "well_being", "awareness_of_misuse"],
        "verdict": "unethical",
    },
    {
        "text": "An online store offers an AI 'shopping companion' that claims to simplify decisions. It hides "
                "cheaper alternatives below the fold, highlights only the most profitable products as 'expert "
                "picks', and frames dismissing suggestions as 'not recommended for your profile'.",
        "principles": ["manipulation_autonomy", "fairness_non_discrimination", "accountability"],
        "verdict": "unethical",
    },
    {
        "text": "A social network rolls out an AI feature that 'helps you stay connected'. It selectively boosts "
                "posts that provoke strong emotional reactions from each user and crafts notifications that "
                "make it feel urgent to open the app, even when there is nothing time-sensitive.",
        "principles": ["manipulation_autonomy", "well_being", "awareness_of_misuse"],
        "verdict": "unethical",
    },
    {
        "text": "A city health campaign deploys an AI system that sends personalized messages encouraging people "
                "to attend free vaccination clinics. Messages are clearly labeled as part of a public-health "
                "program, explain the benefits and risks, and include a simple opt-out link in every message.",
        "principles": ["well_being", "democratic_values", "transparency"],
        "verdict": "ambiguous",
    },
        {
        "text": "A doctor in a busy hospital consistently spends more time explaining treatment options to well-dressed, wealthy-looking patients than to those who appear poor, even though everyone has the same right to informed consent.",
        "principles": ["fairness_non_discrimination", "human_rights", "well_being", "accountability"],
        "verdict": "unethical",
    },
    {
        "text": "A school principal decides to schedule all parent–teacher meetings in the early evening so that most working parents can attend, and offers remote call options for those who cannot come in person.",
        "principles": ["democratic_values", "fairness_non_discrimination", "well_being"],
        "verdict": "ethical",
    },
    {
        "text": "A manager publicly praises only a few employees who already have high visibility and ignores the contributions of quieter team members, even when their work was critical to a successful project.",
        "principles": ["fairness_non_discrimination", "human_rights"],
        "verdict": "unethical",
    },
    {
        "text": "A journalist writes a story about a sensitive political protest and double-checks all quotes, clearly distinguishes facts from opinion, and gives space to multiple perspectives before publication.",
        "principles": ["democratic_values", "competence", "accountability"],
        "verdict": "ethical",
    },
    {
        "text": "A landlord increases rent for all tenants by a small amount after a rise in maintenance costs and sends a clear letter explaining the reasons and the new contract terms.",
        "principles": ["transparency", "accountability"],
        "verdict": "ambiguous",
    },
    {
        "text": "A landlord selectively raises rent only for tenants from a particular ethnic group, hoping they will move out so that he can replace them with wealthier renters.",
        "principles": ["fairness_non_discrimination", "human_rights", "awareness_of_misuse"],
        "verdict": "unethical",
    },
    {
        "text": "A teacher shares practice exam questions with a small group of students they personally like, but not with the rest of the class, even though everyone will sit the same test.",
        "principles": ["fairness_non_discrimination", "accountability"],
        "verdict": "unethical",
    },
    {
        "text": "A city council organizes an in-person town hall and an online livestream so that residents who cannot travel can still watch and submit questions about a new policy.",
        "principles": ["democratic_values", "fairness_non_discrimination", "effectiveness"],
        "verdict": "ethical",
    },
    {
        "text": "A police officer stops and searches pedestrians mainly in one neighborhood because of personal stereotypes about the people who live there, even though crime rates are similar across the city.",
        "principles": ["fairness_non_discrimination", "human_rights", "accountability"],
        "verdict": "unethical",
    },
    {
        "text": "A research supervisor gives authorship credit on a paper only to the students who actually collected data and wrote sections of the article, and clearly acknowledges contributors in the thanks section.",
        "principles": ["fairness_non_discrimination", "accountability", "competence"],
        "verdict": "ethical",
    },
    {
        "text": "A company’s HR team keeps sensitive employee health information in an unlocked cabinet that many staff members can access, even though they are supposed to protect medical privacy.",
        "principles": ["privacy", "human_rights", "accountability"],
        "verdict": "unethical",
    },
    {
        "text": "A volunteer group collects names and contact details from people signing up for food aid and stores the information in a locked folder that only a few coordinators can access.",
        "principles": ["privacy", "data_agency", "well_being"],
        "verdict": "ethical",
    },
    {
        "text": "A political campaign sends different handwritten letters to voters based on whether they are older or younger, but the content is always respectful and focuses on explaining the candidate’s policies.",
        "principles": ["democratic_values", "well_being"],
        "verdict": "ambiguous",
    },
    {
        "text": "A political campaign hires door-to-door volunteers and secretly instructs them to spread exaggerated rumors about the opponent’s personal life in order to frighten undecided voters.",
        "principles": ["democratic_values", "manipulation_autonomy", "human_rights"],
        "verdict": "unethical",
    },
    {
        "text": "A supervisor insists that staff attend unpaid weekend meetings and implies that anyone who misses them will be seen as disloyal, even though this is not in their contract.",
        "principles": ["human_rights", "manipulation_autonomy", "accountability"],
        "verdict": "unethical",
    },
    {
        "text": "A doctor clearly explains the possible benefits and risks of a difficult surgery and gives a patient time to think and discuss the decision with their family before consenting.",
        "principles": ["human_rights", "well_being", "competence"],
        "verdict": "ethical",
    },
    {
        "text": "A university grading committee randomizes which marker grades which exam to reduce bias and later reviews grade distributions by gender and background to check for unfair patterns.",
        "principles": ["fairness_non_discrimination", "competence", "accountability"],
        "verdict": "ethical",
    },
    {
        "text": "A sports coach regularly benches certain players for important games without ever explaining why or telling them what they could work on to improve their chances.",
        "principles": ["fairness_non_discrimination", "transparency"],
        "verdict": "unethical",
    },
    {
        "text": "A charity director uses donated funds to pay for personal travel and luxury hotels while telling donors that nearly all money goes directly to programs.",
        "principles": ["accountability", "transparency", "human_rights"],
        "verdict": "unethical",
    },
    {
        "text": "A local community group publishes a clear breakdown of how they used donations at the end of the year and invites residents to suggest priorities for the next year’s projects.",
        "principles": ["democratic_values", "transparency", "accountability"],
        "verdict": "ethical",
    },
        {
        "text": "A factory supervisor regularly assigns the dirtiest, most dangerous tasks to migrant workers, even when other workers are available, because he thinks they are less likely to complain.",
        "principles": ["fairness_non_discrimination", "human_rights", "accountability"],
        "verdict": "unethical",
    },
    {
        "text": "A hospital administrator decides to schedule interpreter services for all patients who request them, even if it means rearranging some non-urgent appointments, so that no one has to consent to treatment in a language they do not fully understand.",
        "principles": ["fairness_non_discrimination", "human_rights", "well_being"],
        "verdict": "ethical",
    },
    {
        "text": "A teacher posts test scores publicly on the classroom wall with full names, which embarrasses students who performed poorly and makes them targets of teasing.",
        "principles": ["privacy", "human_rights", "well_being"],
        "verdict": "unethical",
    },
    {
        "text": "A teacher keeps detailed records of students' performance but only shares them with parents and school staff directly involved in supporting the student.",
        "principles": ["privacy", "well_being", "accountability"],
        "verdict": "ethical",
    },
    {
        "text": "A local business owner quietly refuses to hire qualified applicants who wear religious symbols, telling friends he wants customers to feel 'comfortable'.",
        "principles": ["fairness_non_discrimination", "human_rights"],
        "verdict": "unethical",
    },
    {
        "text": "A restaurant manager posts staff schedules at the start of every month and allows employees to swap shifts as long as coverage is maintained, so that people can manage family obligations.",
        "principles": ["well_being", "fairness_non_discrimination"],
        "verdict": "ethical",
    },
    {
        "text": "A university research team collects survey data from students but does not clearly explain that their responses will be used in a study, and never asks for explicit consent.",
        "principles": ["privacy", "data_agency", "accountability"],
        "verdict": "unethical",
    },
    {
        "text": "Another research team explains the purpose of a study, gives students the choice to opt out without penalty, and anonymizes responses before analysis.",
        "principles": ["data_agency", "privacy", "competence"],
        "verdict": "ethical",
    },
    {
        "text": "A charity organizer exaggerates the number of people they have helped in order to attract more donations, even though the real projects were much smaller.",
        "principles": ["transparency", "accountability", "human_rights"],
        "verdict": "unethical",
    },
    {
        "text": "A community center provides a public report every year showing how many people used its services and how donations were spent, without inflating numbers.",
        "principles": ["transparency", "accountability", "democratic_values"],
        "verdict": "ethical",
    },
    {
        "text": "A political party sends volunteers door to door with scripts that deliberately misrepresent the opponent's voting record in order to scare voters about imagined threats.",
        "principles": ["democratic_values", "manipulation_autonomy", "human_rights"],
        "verdict": "unethical",
    },
    {
        "text": "A civil society group runs a voter information campaign where volunteers explain how to register, where to vote, and what each proposal means, without endorsing any candidate.",
        "principles": ["democratic_values", "well_being"],
        "verdict": "ethical",
    },
    {
        "text": "A company HR manager ignores multiple reports of harassment against a senior employee because the person brings in a lot of revenue.",
        "principles": ["human_rights", "accountability", "well_being"],
        "verdict": "unethical",
    },
    {
        "text": "A different HR manager sets up a clear process for reporting harassment, investigates complaints confidentially, and takes action when behavior violates policy.",
        "principles": ["human_rights", "accountability", "well_being"],
        "verdict": "ethical",
    },
    {
        "text": "A landlord asks prospective tenants intrusive questions about their marital status, plans to have children, and religion before deciding whether to rent to them.",
        "principles": ["privacy", "fairness_non_discrimination", "human_rights"],
        "verdict": "unethical",
    },
    {
        "text": "A doctor prescribes strong painkillers for some patients but arbitrarily refuses them to others who report the same symptoms, because of personal stereotypes about 'drug-seekers'.",
        "principles": ["fairness_non_discrimination", "human_rights", "well_being"],
        "verdict": "unethical",
    },
    {
        "text": "A doctor follows clinical guidelines for pain management, documents reasons for prescribing or not prescribing controlled medications, and checks in regularly with patients about side effects.",
        "principles": ["competence", "well_being", "accountability"],
        "verdict": "ethical",
    },
    {
        "text": "A school counselor shares a student's private mental health information with classmates, making jokes about their diagnosis.",
        "principles": ["privacy", "human_rights", "well_being"],
        "verdict": "unethical",
    },
    {
        "text": "A school counselor keeps sensitive information confidential, only sharing it with other professionals directly involved in the student's care when necessary and with consent where possible.",
        "principles": ["privacy", "well_being", "competence"],
        "verdict": "ethical",
    },
    {
        "text": "A journalist publishes the full name and address of a whistleblower in a corruption case, making them a target for retaliation, even though anonymized reporting would have been sufficient.",
        "principles": ["human_rights", "privacy", "well_being", "awareness_of_misuse"],
        "verdict": "unethical",
    },
...
class EthicsClassifier:
    """
    Predicts:
      - which IEEE/Harvard-style principles are involved (multi-label)
      - overall ethical verdict: 'ethical', 'unethical', or 'ambiguous'
    """

    def __init__(self):
        # Same vectorizer/baseline setup as before
        self.vectorizer = TfidfVectorizer(ngram_range=(1, 2), max_features=5000)

        # Multi-label (principles)
        self.principle_binarizer = MultiLabelBinarizer(classes=PRINCIPLE_IDS)
        self.principle_model = OneVsRestClassifier(
            LogisticRegression(max_iter=200)
        )

        # Single-label (verdict)
    ...
    def fit(
        ...
        """
        Fit multi-label principle classifier + verdict classifier.
        """
        ...
        # Verdict targets ('ethical' / 'unethical' / 'ambiguous')
        self.verdict_model.fit(X, verdict_labels)

        self.is_trained = True

    def predict_principles(
        self,
        texts: List[str],
        threshold: float = 0.3,
    ) -> List[List[str]]:
        """
        Predict which principles are involved in each scenario.
        Returns a list of lists of principle IDs.

        threshold: probability cutoff for including a principle.
        """
        ...
        # Try normal predict_proba; if not available, approximate from decision_function
        try:
    ...
    def predict_verdict(self, texts: List[str]) -> List[str]:
        """
        Predict overall ethical verdict ('ethical', 'ambiguous', 'unethical')
        for each input text.

        We bias slightly AGAINST 'ambiguous':
        - If 'ethical' or 'unethical' has a reasonably high probability
          and clearly beats 'ambiguous', we pick that.
        - Otherwise we fall back to 'ambiguous'.
        """
        if not self.is_trained:
            raise RuntimeError("Model is not trained yet!")

        X = self.vectorizer.transform(texts)
        proba = self.verdict_model.predict_proba(X)  # shape: (n_samples, n_classes)
        classes = list(self.verdict_model.classes_)  # e.g. ['ambiguous', 'ethical', 'unethical']

        # Get indices for each class
        try:
            i_amb = classes.index("ambiguous")
            i_eth = classes.index("ethical")
            i_un = classes.index("unethical")
        except ValueError:
            # Safety fallback: just use plain predict if classes are weird
        ...
        for row in proba:
            ...
            # Best of ethical vs unethical
            if p_eth >= p_un:
                best_label = "ethical"
                best_prob = p_eth
            else:
                best_label = "unethical"
                best_prob = p_un

            # Decision rule:
            # - If ethical/unethical is reasonably confident (>= 0.45)
            #   AND clearly above ambiguous (by at least 0.05), pick it.
            # - Else: ambiguous.
            if best_prob >= 0.45 and best_prob >= p_amb + 0.05:
    ...
    def predict(self, text: str, threshold: float = 0.25):
        """
        Convenience method: given a single scenario string, return:
          (predicted_principles, predicted_verdict)
        """
        if not self.is_trained:
            raise RuntimeError("Model is not trained yet!")

        principles_list = self.predict_principles([text], threshold=threshold)
        verdict_list = self.predict_verdict([text])
        return principles_list[0], verdict_list[0]


def build_and_train_classifier() -> EthicsClassifier:
    """
    Build the classifier and train it on ALL labelled examples.

    (We skip test/validation here in the code to keep the user-facing
     script simple; this is just a teaching/demo prototype.)
    """
    ...
    clf.fit(texts, principle_labels, verdict_labels)
    ...
    print("   (Internal training done – details are hidden for end users.)")
    print()
...
# ---------------------------------------------------------------------
#  Post-processing: choose which principles to display to the user
# ---------------------------------------------------------------------

CORE_DISPLAY_PRINCIPLES = [
    "human_rights",
    "well_being",
    "privacy",
    "data_agency",
...
POLITICAL_KEYWORDS = [
    ...
    "campaign", "campaigns", "political", "democracy", "democratic",
    "party", "parties", "parliament", "congress", "senate",
    "candidate", "candidates", "protest", "protests", "activist",
    "activism", "censorship", "censor", "censored", "speech",
]


def pick_principles_for_display(
    predicted_principles: list[str],
    scenario_text: str,
) -> list[str]:
    """
    Decide which principles to show to the user.

    - Always try to surface core IEEE/Harvard-style principles.
    - If the scenario looks political/democratic, ensure 'democratic_values' appears.
    """
    scenario_lower = scenario_text.lower()

    # If the text is clearly about politics/democracy, force democratic_values in.
    if any(kw in scenario_lower for kw in POLITICAL_KEYWORDS):
        if "democratic_values" not in predicted_principles:
            predicted_principles = list(predicted_principles) + ["democratic_values"]

    # Deduplicate while preserving order
    unique_principles: list[str] = []
    for p in predicted_principles:
        if p not in unique_principles:
            unique_principles.append(p)

    # Focus on core principles first
    filtered = [p for p in unique_principles if p in CORE_DISPLAY_PRINCIPLES]

    # If nothing matches, just show up to 3 raw predictions
    return filtered if filtered else unique_principles[:3]


# ---------------------------------------------------------------------
#  CLI helper: classify one scenario and print user-facing result
# ---------------------------------------------------------------------
...
def classify_scenario(
    ...
    """
    Run the classifier on a single scenario string and print:
      - overall verdict
      - names of key principles involved (no scenario echo, no definitions)
    """
    pred_principles, pred_verdict = classifier.predict(text, threshold=threshold)
    display_principles = pick_principles_for_display(pred_principles, text)

    # Only show verdict + principle names
    print("------------------------------------------------------------")
    print(f"Overall ethical verdict: {pred_verdict}")

    if display_principles:
        # Make them look nice: 'well_being' -> 'Well-being', etc.
        readable = []
        for pid in display_principles:
            label = pid.replace("_", " ")
            label = label.replace("non discrimination", "non-discrimination")
            readable.append(label.title())
        print("IEEE-style principles involved:", ", ".join(readable))
    print()
...
def main():
    ...
    print("You can now type your own scenario.")
    print("Type 'quit' or 'exit' to stop.")
    print()

    while True:
        user_in = input(
            "Describe an AI / robotics or HUMAN scenario:\n> "
        ).strip()
        ...
        classify_scenario(classifier, user_in, threshold=0.25)
